...
app.get('/health',(_,res)=>res.json({ok:true,app:'TelaShare V2.5 Desktop Pro'}));
...
server.listen(process.env.PORT||3000,'0.0.0.0',()=>console.log('TelaShare V2.5 Desktop Pro online'));
