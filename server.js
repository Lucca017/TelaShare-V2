...
// Página principal: funciona mesmo quando os arquivos são enviados pelo GitHub sem pasta public.
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'index.html'));
});

app.get('/health', (req, res) => {
  res.json({ ok: true, app: 'TelaShare V2' });
});
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`TelaShare V2 iniciado na porta ${PORT}`);
});
